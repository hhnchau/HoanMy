package phuthotech.vn.hospital.model;
...
public class HealthCard implements Parcelable {
    private String sn;
    private String name;
    ...
    public static final Creator<HealthCard> CREATOR = new Creator<HealthCard>() {
        @Override
        public HealthCard createFromParcel(Parcel in) {
            return new HealthCard(in);
        }

        @Override
        public HealthCard[] newArray(int size) {
            return new HealthCard[size];
        }
    };
